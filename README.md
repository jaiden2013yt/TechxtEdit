...
- indexedDB support
- <sub>~~a use share sheet setting~~ added owo ;3</sub>
- proper tab selection support
- color themes (and css (╥‸╥) )
- <sub>~~iframe to display stuff if you are coding html~~ added :3 ~~could use some nicer css tho~~  added split screen :3</sub>
